...
function my_resume_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting('my_resume_logo_size',array(
		'sanitize_callback'	=> 'my_resume_sanitize_float'
	));
	$wp_customize->add_control('my_resume_logo_size',array(
		'type' => 'range',
		'label' => __('Logo Size','my-resume'),
	...
	//Sidebar Section
	$wp_customize->add_section( 'my_resume_sidebar_section' , array(
    	'title' => __( 'Sidebar Section', 'my-resume' ),
		'priority' => null,
		'panel' => 'my_resume_panel_id'
	) );

	$wp_customize->add_setting( 'my_resume_sidebar_menus_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'my_resume_sidebar_menus_color', array(
		'label' => 'Menus Color',
		'section' => 'my_resume_sidebar_section',
	)));

	$wp_customize->add_setting( 'my_resume_sidebar_menusbg_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'my_resume_sidebar_menusbg_color', array(
		'label' => 'Menus Background Color',
		'section' => 'my_resume_sidebar_section',
	)));
	...
	$wp_customize->add_setting('my_resume_banner_img_size',array(
		'default' => '',
		'sanitize_callback'	=> 'my_resume_sanitize_float'
	));
	$wp_customize->add_control('my_resume_banner_img_size',array(
		'type' => 'number',
		'label' => __('Image Size','my-resume'),
		'section' => 'my_resume_banner_section',
	));
	...
	$wp_customize->add_setting('my_resume_slider_title_font_size',array(
		'default' => '',
		'sanitize_callback'	=> 'my_resume_sanitize_float'
	));
	$wp_customize->add_control('my_resume_slider_title_font_size',array(
		'type' => 'number',
		'label' => __('Title Font Size','my-resume'),
		'section' => 'my_resume_banner_section',
	));

	$wp_customize->add_setting('my_resume_slider_name_font_size',array(
		'default' => '',
		'sanitize_callback'	=> 'my_resume_sanitize_float'
	));
	$wp_customize->add_control('my_resume_slider_name_font_size',array(
		'type' => 'number',
		'label' => __('Name Font Size','my-resume'),
		'section' => 'my_resume_banner_section',
	));

	$wp_customize->add_setting('my_resume_slider_designation_font_size',array(
		'default' => '',
		'sanitize_callback'	=> 'my_resume_sanitize_float'
	));
	$wp_customize->add_control('my_resume_slider_designation_font_size',array(
		'type' => 'number',
		'label' => __('Designation Font Size','my-resume'),
		'section' => 'my_resume_banner_section',
	));

	$wp_customize->add_setting('my_resume_slider_text_font_size',array(
		'default' => '',
		'sanitize_callback'	=> 'my_resume_sanitize_float'
	));
	$wp_customize->add_control('my_resume_slider_text_font_size',array(
		'type' => 'number',
		'label' => __('Text Font Size','my-resume'),
		'section' => 'my_resume_banner_section',
	));

	$wp_customize->add_setting('my_resume_slider_opacity',array(
		'default' => '',
		'sanitize_callback'	=> 'my_resume_sanitize_float'
	));
	$wp_customize->add_control('my_resume_slider_opacity',array(
		'type' => 'range',
		'label' => __('Image Opacity','my-resume'),
		'section' => 'my_resume_banner_section',
		'input_attrs' => array(
			'min' => 0,
			'max' => 1,
	...
	$wp_customize->add_setting( 'my_resume_des_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'my_resume_des_color', array(
	...
	$wp_customize->add_setting('my_resume_skills_title_font_size',array(
		'default' => '',
		'sanitize_callback'	=> 'my_resume_sanitize_float'
	));
	$wp_customize->add_control('my_resume_skills_title_font_size',array(
		'type' => 'number',
		'label' => __('Title Font Size','my-resume'),
		'section' => 'my_resume_skills_section',
	));

	$wp_customize->add_setting('my_resume_skills_text_font_size',array(
		'default' => '',
		'sanitize_callback'	=> 'my_resume_sanitize_float'
	));
	$wp_customize->add_control('my_resume_skills_text_font_size',array(
		'type' => 'number',
		'label' => __('Text Font Size','my-resume'),
		'section' => 'my_resume_skills_section',
	));
   ...
   $wp_customize->add_section( 'my_resume_footer', array(
	...
	$wp_customize->add_control('my_resume_show_back_totop',array(
 	...
 	$wp_customize->add_setting('my_resume_footer_link',array(
		'default'	=> 'https://www.luzuk.com/products/free-resume-wordpress-theme/',
		'sanitize_callback'	=> 'sanitize_text_field'
	));	
	...
	$wp_customize->add_setting('my_resume_footer_copy_font_size',array(
		'default' => '',
		'sanitize_callback'	=> 'my_resume_sanitize_float'
	));
	$wp_customize->add_control('my_resume_footer_copy_font_size',array(
		'type' => 'number',
		'label' => __('Text Font Size','my-resume'),
		'section' => 'my_resume_footer',
	));
	...
	$wp_customize->add_setting( 'my_resume_copyright_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'my_resume_copyright_color', array(
		'label' => 'Copyright Color',
		'section' => 'my_resume_footer',
	)));

	$wp_customize->add_setting( 'my_resume_copyrightbg_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'my_resume_copyrightbg_color', array(
		'label' => 'Copyright Bg Color',
		'section' => 'my_resume_footer',
	)));

	$wp_customize->add_setting( 'my_resume_footer_widgets_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'my_resume_footer_widgets_color', array(
		'label' => 'Widgets Title Color',
		'section' => 'my_resume_footer',
	)));

	$wp_customize->add_setting( 'my_resume_footer_widgets_menu_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'my_resume_footer_widgets_menu_color', array(
		'label' => 'Widgets Menus Color',
		'section' => 'my_resume_footer',
	)));

	$wp_customize->add_setting( 'my_resume_footerbg_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'my_resume_footerbg_color', array(
