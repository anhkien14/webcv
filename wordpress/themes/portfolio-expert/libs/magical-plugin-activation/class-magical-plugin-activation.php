...
class magical_plugin_activation_Plugin_Recommendations
{
    ...
    {
        add_theme_page(
            __('Recommended Plugins', 'portfolio-expert'),
            __('Recommended Plugins', 'portfolio-expert'),
            'manage_options',
    ...
    public function get_recommended_plugins()
    {
        ...
        $default_plugins = array(
            'easy-share-solution' => array(
                'name' => __('Easy Share Solution', 'portfolio-expert'),
                'slug' => 'easy-share-solution',
                'file' => 'easy-share-solution/easy-share-solution.php',
                'description' => __('Easily add social sharing buttons to your content.', 'portfolio-expert'),
                'category' => 'Utility',
                'required' => false,
                'featured' => true,
                'is_local' => false
            ...
            'wp-edit-password-protected' => array(
                'name' => __('WP Edit Password Protected', 'portfolio-expert'),
                'slug' => 'wp-edit-password-protected',
                'file' => 'wp-edit-password-protected/wp-edit-password-protected.php',
                'description' => __('Easily manage password protection for your WordPress content.', 'portfolio-expert'),
                'category' => 'Security',
                'required' => false,
                'featured' => true,
                'is_local' => false
...
?>
        <div class="wrap magical-plugin-activation-plugins">
            <h1><?php printf(esc_html__('Recommended Plugins for %s', 'portfolio-expert'), $this->theme_name); ?></h1>
            <p class="description">
                <?php printf(esc_html__('These plugins are recommended to enhance your %s theme experience. They work perfectly with the theme\'s features and animations.', 'portfolio-expert'), $this->theme_name); ?>
            </p>
            ...
            ?>
                <div class="notice notice-warning">
                    <p>
                        <strong><?php esc_html_e('Missing Required Plugins:', 'portfolio-expert'); ?></strong>
                        <?php printf(esc_html__('%d required plugins are missing or inactive.', 'portfolio-expert'), count($missing_required)); ?>
                        <button id="install-required-plugins" class="button button-primary" style="margin-left: 10px;">
                            <?php esc_html_e('Install Required Plugins', 'portfolio-expert'); ?>
                        </button>
                    </p>
                </div>
            <?php endif; ?>
            ...
            <div class="plugin-filter-tabs">
                <?php if ($plugin_counts['all'] > 0) : ?>
                    <button class="filter-tab <?php echo esc_attr( ($first_active_tab === 'all') ? 'active' : '' ); ?>" data-filter="all"><?php printf(esc_html__('All Plugins (%d)', 'portfolio-expert'), $plugin_counts['all']); ?></button>
                <?php endif; ?>

                <?php if ($plugin_counts['featured'] > 0) : ?>
                    <button class="filter-tab <?php echo esc_attr( ($first_active_tab === 'featured') ? 'active' : '' ); ?>" data-filter="featured"><?php printf(esc_html__('Featured (%d)', 'portfolio-expert'), $plugin_counts['featured']); ?></button>
                <?php endif; ?>

                <?php if ($plugin_counts['required'] > 0) : ?>
                    <button class="filter-tab <?php echo esc_attr( ($first_active_tab === 'required') ? 'active' : '' ); ?>" data-filter="required"><?php printf(esc_html__('Required (%d)', 'portfolio-expert'), $plugin_counts['required']); ?></button>
                <?php endif; ?>

                <?php if ($plugin_counts['active'] > 0) : ?>
                    <button class="filter-tab <?php echo esc_attr( ($first_active_tab === 'active') ? 'active' : '' ); ?>" data-filter="active"><?php printf(esc_html__('Active (%d)', 'portfolio-expert'), $plugin_counts['active']); ?></button>
                <?php endif; ?>

                <?php if ($plugin_counts['inactive'] > 0) : ?>
                    <button class="filter-tab <?php echo esc_attr( ($first_active_tab === 'inactive') ? 'active' : '' ); ?>" data-filter="inactive"><?php printf(esc_html__('Inactive (%d)', 'portfolio-expert'), $plugin_counts['inactive']); ?></button>
                <?php endif; ?>

                <?php if ($plugin_counts['not-installed'] > 0) : ?>
                    <button class="filter-tab <?php echo esc_attr( ($first_active_tab === 'not-installed') ? 'active' : '' ); ?>" data-filter="not-installed"><?php printf(esc_html__('Not Installed (%d)', 'portfolio-expert'), $plugin_counts['not-installed']); ?></button>
                <?php endif; ?>
            </div>
            ...
            <div class="plugins-grid">
                ...
                ?>
                    <div class="plugin-card <?php echo esc_attr($featured_class); ?>" data-status="<?php echo esc_attr($status); ?>" data-featured="<?php echo esc_attr( $plugin['featured'] ? '1' : '0' ); ?>" data-required="<?php echo esc_attr( $plugin['required'] ? '1' : '0' ); ?>" data-local="<?php echo esc_attr( $is_local ? '1' : '0' ); ?>" data-slug="<?php echo esc_attr($slug); ?>">
                        <?php if ($plugin['featured']) : ?>
                            <div class="featured-badge"><?php esc_html_e('Featured', 'portfolio-expert'); ?></div>
                        <?php endif; ?>

                        <?php if ($plugin['required']) : ?>
                            <div class="required-badge"><?php esc_html_e('Required', 'portfolio-expert'); ?></div>
                        <?php endif; ?>

                        <?php if ($is_local) : ?>
                            <div class="local-plugin-badge"><?php esc_html_e('Local', 'portfolio-expert'); ?></div>
                        <?php endif; ?>
    ...
    private function render_plugin_button($slug, $plugin, $status)
    {
        ...
        switch ($status) {
            case 'active':
                echo '<span class="button disabled">' . esc_html__('Active', 'portfolio-expert') . '</span>';
                break;
            case 'needs-update':
                echo '<button class="button button-secondary update-plugin" data-slug="' . esc_attr($slug) . '" data-file="' . esc_attr($plugin['file']) . '" data-is-local="' . ($is_local ? '1' : '0') . '">' . esc_html__('Update', 'portfolio-expert') . '</button>';
                break;
            case 'inactive':
                echo '<button class="button button-primary activate-plugin" data-slug="' . esc_attr($slug) . '" data-file="' . esc_attr($plugin['file']) . '">' . esc_html__('Activate', 'portfolio-expert') . '</button>';
                break;
            case 'inactive-needs-update':
                echo '<button class="button button-secondary update-plugin" data-slug="' . esc_attr($slug) . '" data-file="' . esc_attr($plugin['file']) . '" data-is-local="' . ($is_local ? '1' : '0') . '">' . esc_html__('Update', 'portfolio-expert') . '</button>';
                break;
            case 'not-installed':
                if ($is_local) {
                    echo '<button class="button button-primary install-plugin" data-slug="' . esc_attr($slug) . '" data-is-local="1">' . esc_html__('Install', 'portfolio-expert') . '</button>';
                } else {
                    echo '<button class="button button-primary install-plugin" data-slug="' . esc_attr($plugin['slug']) . '" data-is-local="0">' . esc_html__('Install', 'portfolio-expert') . '</button>';
                }
                break;
        }
        ...
        if ($current_version && $required_version) {
            ...
            printf(esc_html__('Current: %s | Required: %s', 'portfolio-expert'), $current_version, $required_version);
            echo '</small>';
        } elseif ($current_version) {
            echo '<small class="version-info">';
            printf(esc_html__('Version: %s', 'portfolio-expert'), $current_version);
            echo '</small>';
        } elseif ($required_version) {
            echo '<small class="version-info">';
            printf(esc_html__('Required Version: %s', 'portfolio-expert'), $required_version);
            echo '</small>';
        }
    }
    ...
    private function get_status_text($status)
    {
        switch ($status) {
            case 'active':
                return __('Active', 'portfolio-expert');
            case 'needs-update':
                return __('Update Available', 'portfolio-expert');
            case 'inactive':
                return __('Installed but not active', 'portfolio-expert');
            case 'inactive-needs-update':
                return __('Update Available (Inactive)', 'portfolio-expert');
            case 'not-installed':
                return __('Not installed', 'portfolio-expert');
            default:
                return __('Unknown', 'portfolio-expert');
        }
    }
    ...
    ?>
        <div class="notice notice-warning is-dismissible magical-plugin-activation-pro-update-notice">
            <div class="plugin-update-content">
                <div style="flex: 1;">
                    <h3><?php esc_html_e('Plugin Updates Available', 'portfolio-expert'); ?></h3>
                    <p><?php printf(esc_html__('%d plugins have updates available. Keep your plugins up to date for better security and performance.', 'portfolio-expert'), count($plugins_need_update)); ?></p>
                    <div style="display: flex; gap: 12px; align-items: center; flex-wrap: wrap; margin-top: 15px;">
                        <button id="update-all-plugins" class="button button-primary"><?php esc_html_e('Update All Plugins', 'portfolio-expert'); ?></button>
                        <a href="<?php echo esc_url(admin_url('themes.php?page=magical-plugin-activation-plugins')); ?>" class="button button-secondary"><?php esc_html_e('Manage Plugins', 'portfolio-expert'); ?></a>
                    </div>
                </div>
    ...
    public function ajax_update_all_plugins()
    {
        ...
        if (!current_user_can('update_plugins')) {
            wp_die(__('You do not have permission to update plugins.', 'portfolio-expert'));
        }
        ...
        if ($success_count === $total_count) {
            wp_send_json_success(array(
                'message' => sprintf(__('%d plugins updated successfully.', 'portfolio-expert'), $success_count),
                'results' => $results
            ));
        } else {
            wp_send_json_error(array(
                'message' => sprintf(__('%d of %d plugins updated successfully.', 'portfolio-expert'), $success_count, $total_count),
                'results' => $results
            ));
        }
    }
    ...
    public function enqueue_admin_scripts($hook)
    {
        ...
        wp_localize_script('magical-plugin-activation-plugins-admin', 'MagicalPluginActivation', array(
            ...
            'strings' => array(
                'installing' => __('Installing...', 'portfolio-expert'),
                'activating' => __('Activating...', 'portfolio-expert'),
                'updating' => __('Updating...', 'portfolio-expert'),
                'installed' => __('Installed', 'portfolio-expert'),
                'activated' => __('Activated', 'portfolio-expert'),
                'updated' => __('Updated', 'portfolio-expert'),
                'active' => __('Active', 'portfolio-expert'),
                'inactive' => __('Inactive', 'portfolio-expert'),
                'notInstalled' => __('Not Installed', 'portfolio-expert'),
                'needsUpdate' => __('Update Available', 'portfolio-expert'),
                'inactiveNeedsUpdate' => __('Update Available (Inactive)', 'portfolio-expert'),
                'install' => __('Install', 'portfolio-expert'),
                'activate' => __('Activate', 'portfolio-expert'),
                'update' => __('Update', 'portfolio-expert'),
                'error' => __('Error occurred', 'portfolio-expert'),
                'requiredWarning' => __('You must install and activate all required plugins before dismissing this notice. Click Dismiss again to hide this warning.', 'portfolio-expert'),
            )
        ));
    ...
    public function ajax_install_plugin()
    {
        ...
        if (!current_user_can('install_plugins')) {
            wp_die(__('You do not have permission to install plugins.', 'portfolio-expert'));
        }
        ...
        if ($is_local) {
            ...
            if (!isset($plugins[$slug])) {
                wp_send_json_error(__('Plugin not found in recommendations.', 'portfolio-expert'));
            }
            ...
            if (!isset($plugin['source']) || !file_exists($plugin['source'])) {
                ...
                if (!isset($plugin['source']) || !file_exists($plugin['source'])) {
                    wp_send_json_error(__('Local plugin zip file not found. Please ensure the plugin zip file exists in the theme directory.', 'portfolio-expert'));
                }
            }
            ...
            if (!is_writable(WP_PLUGIN_DIR)) {
                wp_send_json_error(__('Plugins directory is not writable. Please check directory permissions.', 'portfolio-expert'));
            }

            $result = $this->install_local_plugin($plugin);

            if ($result) {
                wp_send_json_success(__('Local plugin installed successfully.', 'portfolio-expert'));
            } else {
                wp_send_json_error(__('Local plugin installation failed. Please check error logs for details.', 'portfolio-expert'));
            }
        } else {
            ...
            if (is_wp_error($api)) {
                wp_send_json_error(__('Plugin information could not be retrieved.', 'portfolio-expert'));
            }
            ...
            if ($install) {
                wp_send_json_success(__('Plugin installed successfully.', 'portfolio-expert'));
            } else {
                wp_send_json_error(__('Plugin installation failed.', 'portfolio-expert'));
            }
        }
    }
    ...
    public function ajax_activate_plugin()
    {
        ...
        if (!current_user_can('activate_plugins')) {
            wp_die(__('You do not have permission to activate plugins.', 'portfolio-expert'));
        }
        ...
        if (is_wp_error($result)) {
            ...
            wp_send_json_success(__('Plugin activated successfully.', 'portfolio-expert'));
        }
    }
    ...
    public function ajax_update_plugin()
    {
        ...
        if (!isset($plugins[$slug])) {
            wp_send_json_error(__('Plugin not found.', 'portfolio-expert'));
        }
        ...
        if ($is_local) {
            ...
            if ($result) {
                wp_send_json_success(__('Local plugin updated successfully.', 'portfolio-expert'));
            } else {
                wp_send_json_error(__('Failed to update local plugin.', 'portfolio-expert'));
            }
        } else {
            ...
            if ($result) {
                wp_send_json_success(__('Plugin updated successfully.', 'portfolio-expert'));
            } else {
                wp_send_json_error(__('Failed to update plugin.', 'portfolio-expert'));
            }
        }
    }
    ...
    public function ajax_install_required_plugins()
    {
        ...
        if ($success_count === $total_count) {
            wp_send_json_success(array(
                'message' => sprintf(__('%d required plugins installed and activated successfully.', 'portfolio-expert'), $success_count),
                'results' => $results
            ));
        } else {
            wp_send_json_error(array(
                'message' => sprintf(__('%d of %d required plugins installed successfully.', 'portfolio-expert'), $success_count, $total_count),
                'results' => $results
            ));
        }
    }
    ...
    public function ajax_install_recommended_plugins()
    {
        ...
        if ($success_count === $total_count) {
            wp_send_json_success(array(
                'message' => sprintf(__('%d recommended plugins installed and activated successfully.', 'portfolio-expert'), $success_count),
                'results' => $results
            ));
        } else {
            wp_send_json_error(array(
                'message' => sprintf(__('%d of %d recommended plugins installed successfully.', 'portfolio-expert'), $success_count, $total_count),
                'results' => $results
            ));
        }
    }
    ...
    public function ajax_check_recommended_plugins_status()
    {
        ...
        wp_send_json_success(array(
            ...
            'message' => $all_active ? __('All recommended plugins are active!', 'portfolio-expert') : __('Some recommended plugins are not active.', 'portfolio-expert')
        ));
    }
        ...
        ?>
                <div class="notice notice-warning magical-plugin-activation-pro-required-notice">
                    <p>
                        ...
                        <?php printf(esc_html__('%d required plugins are missing. Please install them for optimal theme functionality.', 'portfolio-expert'), count($missing_required)); ?>
                        <br><br>
                        ...
                        <a href="<?php echo esc_url(admin_url('themes.php?page=magical-plugin-activation-plugins')); ?>" class="button button-secondary">
                            <?php esc_html_e('View All Plugins', 'portfolio-expert'); ?>
                        </a>
                        <button id="install-dismiss" class="button install-dismiss" style="margin-left: 10px;">
                            <?php esc_html_e('Dismiss', 'portfolio-expert'); ?>
                        </button>
    ...
    private function show_recommended_plugins_notice()
    {
        ...
        <div class="notice notice-info is-dismissible magical-plugin-activation-pro-recommended-notice">
            <div class="plugin-recommended-content">
                <div style="flex: 1;">
                    <h3><?php printf(esc_html__('Recommended Plugins for %s', 'portfolio-expert'), $this->theme_name); ?></h3>
                    <p><?php printf(esc_html__('We recommend %d additional plugins to enhance your %s theme experience.', 'portfolio-expert'), count($inactive_recommended), $this->theme_name); ?></p>
                    <div style="display: flex; gap: 12px; align-items: center; flex-wrap: wrap; margin-top: 15px;">
                        <button id="install-recommended-plugins" class="button button-primary"><?php esc_html_e('Install Recommended Plugins', 'portfolio-expert'); ?></button>
                        <a href="<?php echo esc_url(admin_url('themes.php?page=magical-plugin-activation-plugins')); ?>" class="button button-secondary"><?php esc_html_e('View All Plugins', 'portfolio-expert'); ?></a>
