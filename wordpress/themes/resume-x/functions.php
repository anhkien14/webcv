...
function resume_x_fonts_url()
{
	...
	$font_families[] = 'Montserrat:ital,wght@0,400;0,700;1,400;1,700';
...
function resume_x_scripts()
{
	...
	// RTL support
	if (is_rtl()) {
		wp_enqueue_style('resume-x-rtl', get_template_directory_uri() . '/rtl.css', array('resume-x-style'), RESUME_X_VERSION);
	}
 ...
 */
require get_template_directory() . '/libs/activation/plugin-data.php';
...
function resume_x_excerpt_more($more)
{
	return '...';
}
add_filter('excerpt_more', 'resume_x_excerpt_more');
