...
= 2.3.2 =
  - Added image size option for banner in customizer.
...
= 2.3.5 =
  - Added font size option for skills section in customizer.
...
= 2.3.8 =
  - Added more font size option for banner section in customizer.

= 2.3.9 =
  - Made some changes.

= 2.4.0 =
  - Added more color options for footer settings in customizer.
...
= 2.4.7 =
  - Added banner image opacity change option in customizer.
